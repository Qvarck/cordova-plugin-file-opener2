...
```shell
$ cordova plugin add https://github.com/Qvarck/cordova-plugin-file-opener2.git
```
...
```shell
$ cordova plugin add https://github.com/Qvarck/cordova-plugin-file-opener2.git  --variable ANDROID_SUPPORT_V4_VERSION="27.+"
```
